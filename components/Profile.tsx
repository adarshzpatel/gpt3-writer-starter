...
<div className='p-[1px] rounded-xl shadow-xl hover:shadow-2xl duration-300 ease-out hover:scale-105 bg-gradient-to-br from-neutral-500 via-neutral-800/50 to-neutral-600 fixed bottom-8 left-[50%] -translate-x-[50%]' >
  ...
  <p className='text-neutral-400 p-2 px-4'>  built by <em className='text-white'> Adarsh Patel </em></p>
  ...
  <a href={links.LINKEDIN} target='_blank' rel='noreferrer' className='p-2 text-neutral-400 hover:bg-neutral-700/50 hover:text-white duration-200'>
    <AiFillLinkedin  size={24}/>
  </a>
  <a href={links.TWITTER} target='_blank' rel='noreferrer' className='p-2 text-neutral-400 hover:bg-neutral-700/50 hover:text-white duration-200'>
